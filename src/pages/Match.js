        ...
        <div id="match-form">
            <div className="match-form__left box--shadow">
                <div className='match-row'>
                    <div className="match-element match-element__border-lefttop">
                    ...
                    <div className="match-element block-element"></div>
                    <div className="match-element match-element__border-righttop">
                        <p className='match-element__score'>?</p>
                        <p className='match-element__split'>st/en/t/d/u</p>
                    </div>
                </div>
                ...
                <div className='match-row'>
                    ...
                    <input className='element-answer box--shadow' type="text" placeholder='Enter your answer here!' />
                    {/* <div className="match-element block-element"></div> */}
                    <div className="match-element">
                        <p className='match-element__score'>?</p>
                        <p className='match-element__split'>st/en/t/d/u</p>
                ...
                <div className='match-row'>
                    ...
                    <div className="match-element block-element"></div>
                    <div className="match-element match-element__active box--shadow">
                ...
                <div className='match-row'>
                    <div className="match-element match-element__border-leftbottom">
                        <p className='match-element__score'>?</p>
                        <p className='match-element__split'>in/ve/st/ig/at/ion</p>
                    </div>
                    <div className="match-element block-element"></div>
                    ...
                    <div className="match-element block-element"></div>
                    <div className="match-element match-element__border-rightbottom">
                        <p className='match-element__score'>?</p>
                        <p className='match-element__split'>st/en/t/d/u</p>
                    </div>
                </div>
